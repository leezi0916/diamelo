...
<form action="signUp.me" method="post" id="enroll-form">
    <div class="container">
        ...
        <div class="form-container">
            ...
            <div class="input-boxs">
                <input class="input-box" type="text" placeholder="아이디" name="userId" required onkeyup="idCheck(this)"/>

                <div class="error-message">
                    <%-- Ajax로 반환되는 값 통해서 text 추가 --%>
                </div>
    ...
    <script>
        ...
        function validateForm() {
            ...
            if (userId.length < 5) { // 아이디 길이 확인 검증
                alert("아이디는 5글자 이상이어야 합니다.");
                return false;
            }

            if (pwd !== pwdCheck) { // 비밀번호 , 비밀번호 확인 같은지 여부 검증
            ...
            if (!btnStatus) { // 직원, 기업/개인 버튼 클릭 여부 검증
