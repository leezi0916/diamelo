            ...
            <div class="div-area">
                <div class="div-loginarea">
                    <div class="div-area1">
                        ...
                        <form action="myPageCheckPw.me" id="form1" method="post">
                            <div id="loginFormdiv">
                                <div id="thId">
                                    <svg
                                        width="40"
                                    ...
                                    <input type="text" value="${loginUser.userId}" name="userId" readonly />
                                </div>
                                ...
                                <input class="loginForm" type="submit" value="확인" />
                                <input class="loginForm" type="button" value="뒤로가기" onclick="location.href='/'" />
                            </div>
                        </form>
                    </div>
                </div>
